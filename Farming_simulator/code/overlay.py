...
class Overlay:
    def __init__(self, player):
        ...
        # imports
        overlay_path=os.path.join(os.path.dirname(os.path.dirname(__file__)), 'graphics', 'overlay')
        ...
        #     print(os.path.join(overlay_path, f"{tool}.png" )) 
        # for seed in player.seeds:
        #     print(os.path.join(overlay_path, f"{seed}.png" ))
        pass
